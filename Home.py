...
st.markdown("- Checks stock performance over long periods of time & compare individual stocks with index.")
st.markdown("- The information empowers users to make decisions on long term investments.")
st.markdown("- **Percent Change Graph**: displays how much the stock price changed compared to [x] years ago (set by the user).")
st.markdown("For example, if Interval of Years = 7, the stock price in 2020 displayed on the chart will be compared to the stock price in 2013.")
st.divider()
